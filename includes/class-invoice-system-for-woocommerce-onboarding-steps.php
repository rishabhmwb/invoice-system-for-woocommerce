...
class Invoice_System_For_Woocommerce_Onboarding_Steps {
	...
	/**
	 * Portal id of hubspot api for invoice-system-for-woocommerce.
	 *
	 * @since 1.0.0
	...
	/**
	 * Form id of hubspot api for invoice-system-for-woocommerce.
	 *
	 * @since 1.0.0
	 * @var string Form id.
	 */
	...
	/**
	 * Define some variables for invoice-system-for-woocommerce.
	 *
	 * @since 1.0.0
	...
	public function __construct() {
		...
		self::$mwb_isfw_plugin_name_label = 'Invoice System For WooCommerce';
	...
	public function mwb_isfw_onboarding_enqueue_styles() {
		...
		if ( $this->mwb_isfw_valid_page_screen_check() || $is_valid ) {
			...
			wp_enqueue_style( 'mwb-isfw-onboarding-style', INVOICE_SYSTEM_FOR_WOOCOMMERCE_DIR_URL . 'onboarding/css/invoice-system-for-woocommerce-onboarding.css', array(), time(), 'all' );
	...
	public function mwb_isfw_onboarding_enqueue_scripts() {
		...
		if ( $this->mwb_isfw_valid_page_screen_check() || $is_valid ) {
			...
			wp_enqueue_script( 'mwb-isfw-onboarding-select2-js', INVOICE_SYSTEM_FOR_WOOCOMMERCE_DIR_URL . 'package/lib/select-2/invoice-system-for-woocommerce-select2.js', array( 'jquery' ), '1.0.0', false );
			...
			wp_enqueue_script( 'mwb-isfw-onboarding-scripts', INVOICE_SYSTEM_FOR_WOOCOMMERCE_DIR_URL . 'onboarding/js/invoice-system-for-woocommerce-onboarding.js', array( 'jquery', 'mwb-isfw-onboarding-select2-js', 'mwb-isfw-metarial-js', 'mwb-isfw-metarial-js2', 'mwb-isfw-metarial-lite' ), time(), true );
	...
	/**
	 * Get all valid screens to add scripts and templates for invoice-system-for-woocommerce.
	 *
	 * @since    1.0.0
	 */
	public function mwb_isfw_add_onboarding_popup_screen() {
		if ( $this->mwb_isfw_valid_page_screen_check() && $this->mwb_isfw_show_onboarding_popup_check() ) {
			require_once INVOICE_SYSTEM_FOR_WOOCOMMERCE_DIR_PATH . 'onboarding/templates/invoice-system-for-woocommerce-onboarding-template.php';
		}
	}
	...
	/**
	 * Skip the popup for some days of invoice-system-for-woocommerce.
	 *
	 * @since    1.0.0
	 */
	...
	/**
	 * Add your invoice-system-for-woocommerce onboarding form fields.
	 *
	 * @since    1.0.0
	 */
	public function mwb_isfw_add_on_boarding_form_fields() {
		...
		$fields = array(
			...
			wp_rand() => array(
				...
				'value'       => self::$mwb_isfw_plugin_name_label,
				'required'    => '',
				'class'       => '',
			),
		);
	...
	/**
	 * Add your invoice-system-for-woocommerce deactivation form fields.
	 *
	 * @since    1.0.0
	 */
