 ...
 * @subpackage Invoice_system_for_woocommere/package/rest-api/version1
 */
 ...
 */
class Invoice_system_for_woocommere_Rest_Api {
	 ...
	 *
	 * Uses the Invoice_system_for_woocommere_Rest_Api class in order to create the endpoint
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	public function mwb_isfw_default_callback( $request ) {
		...
		require_once INVOICE_SYSTEM_FOR_WOOCOMMERE_DIR_PATH . 'package/rest-api/version1/class-invoice-system-for-woocommere-api-process.php';
		$mwb_isfw_api_obj = new Invoice_system_for_woocommere_Api_Process();
