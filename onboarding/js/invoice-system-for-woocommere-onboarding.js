jQuery(document).ready(function($) {
    ...
    function mwb_isfw_show_onboard_popup() {
        ...
        // jQuery( '.mwb-isfw-onboarding-section' ).show();
        // jQuery( '.mwb-isfw-on-boarding-wrapper-background' ).addClass( 'mwb-isfw-onboard-popup-show' );
        dialog.open();
    ...
    function mwb_isfw_hide_onboard_popup() {
        // jQuery( '.mwb-isfw-on-boarding-wrapper-background' ).removeClass( 'mwb-isfw-onboard-popup-show' );
        // jQuery( '.mwb-isfw-onboarding-section' ).hide();
        if (!jQuery('body').hasClass('mobile-device')) {
