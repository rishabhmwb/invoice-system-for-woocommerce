		...
		<div class="mwb-isfw-on-boarding-wrapper-background mdc-dialog__container">
			<div class="mwb-isfw-on-boarding-wrapper mdc-dialog__surface" role="alertdialog" aria-modal="true" aria-labelledby="my-dialog-title" aria-describedby="my-dialog-content">
				<div class="mdc-dialog__content">
					...
					<h3 class="mwb-isfw-on-boarding-heading mdc-dialog__title"><?php esc_html_e( 'Welcome to MakeWebBetter', 'invoice-system-for-woocommere' ); ?> </h3>
					<p class="mwb-isfw-on-boarding-desc"><?php esc_html_e( 'We love making new friends! Subscribe below and we promise to keep you up-to-date with our latest new plugins, updates, awesome deals and a few special offers.', 'invoice-system-for-woocommere' ); ?></p>
					...
					<form action="#" method="post" class="mwb-isfw-on-boarding-form">
						...
						<div class="mwb-isfw-on-boarding-form-btn__wrapper mdc-dialog__actions">
							...
							<div class="mwb-isfw-on-boarding-form-no_thanks">
								<a href="#" class="mwb-isfw-on-boarding-no_thanks mdc-button" data-mdc-dialog-action="discard"><?php esc_html_e( 'Skip For Now', 'invoice-system-for-woocommere' ); ?></a>
							</div>
						</div>
					</form>
				</div>
