...
$isfw_template_settings = apply_filters( 'isfw_template_settings_array', array() );
?>
<!--  template file for admin settings. -->
<div class="isfw-section-wrap">
	<?php
		$isfw_template_html = $isfw_mwb_isfw_obj->mwb_isfw_plug_generate_html( $isfw_template_settings );
