		...
		<div id="mwb-isfw-table-inner-container" class="table-responsive mdc-data-table">
			<div class="mdc-data-table__table-container">
				<table class="mwb-isfw-table mdc-data-table__table mwb-table" id="mwb-isfw-wp">
					<thead>
						<tr>
							<th class="mdc-data-table__header-cell"><?php esc_html_e( 'WP Variables', 'invoice-system-for-woocommere' ); ?></th>
							<th class="mdc-data-table__header-cell"><?php esc_html_e( 'WP Values', 'invoice-system-for-woocommere' ); ?></th>
						</tr>
					</thead>
		...
		<div id="mwb-isfw-table-inner-container" class="table-responsive mdc-data-table">
			<div class="mdc-data-table__table-container">
				<table class="mwb-isfw-table mdc-data-table__table mwb-table" id="mwb-isfw-sys">
					<thead>
						<tr>
							<th class="mdc-data-table__header-cell"><?php esc_html_e( 'Sysytem Variables', 'invoice-system-for-woocommere' ); ?></th>
							<th class="mdc-data-table__header-cell"><?php esc_html_e( 'System Values', 'invoice-system-for-woocommere' ); ?></th>
						</tr>
					</thead>
					<tbody class="mdc-data-table__content">
